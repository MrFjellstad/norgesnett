...
from custom_components.norgesnett import async_setup_entry
from custom_components.norgesnett.const import DEFAULT_NAME, DOMAIN, SWITCH
...
async def test_switch_services(hass):
    ...
    with patch(
        "custom_components.norgesnett.NorgesnettApiClient.async_set_title"
    ) as title_func:
